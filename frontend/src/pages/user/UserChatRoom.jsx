        ...
        <div>
            ...
            <div className="flex items-start gap-2.5 ml-[80px] mt-[33px] mr-[10px]">
                <div className="flex flex-col gap-1 w-full max-w-[320px]">
                    ...
                    <div className="flex flex-col leading-1.5 p-4 border-gray-200 bg-yellow-400 rounded-e-xl rounded-es-xl dark:bg-gray-700">
                        <p className="text-sm font-bold text-white dark:text-white">허허 세상만사 새옹지마 아니겠습니까</p>
                    </div>
                    <span className="text-sm font-normal text-gray-500 dark:text-gray-400">확인함</span>
                </div>
            </div>
            <div className="bottom-10 w-full p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                <input 
                    type="text" 
